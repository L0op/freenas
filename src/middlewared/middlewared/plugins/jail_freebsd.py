...
class PluginService(CRUDService):
    ...
    def do_create(self, job, data):
        ...
        """
        self.middleware.call_sync('system.advanced.will_perform_network_activity', 'jail')
...
async def setup(middleware):
    ...
    await middleware.call('system.advanced.register_network_activity', 'jail', 'Plugin registry')
