...
class VMWareService(CRUDService):
    ...
    def __get_datastores(self, data):
        self.middleware.call_sync('system.advanced.will_perform_network_activity', 'vmware')
    ...
    async def get_virtual_machines(self, pk):
        ...
        """
        await self.middleware.call('system.advanced.will_perform_network_activity', 'vmware')
...
async def setup(middleware):
    await middleware.call('system.advanced.register_network_activity', 'vmware', 'VMware')
