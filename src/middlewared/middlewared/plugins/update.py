...
class UpdateService(Service):
    ...
    def get_trains(self):
        ...
        self.middleware.call_sync('system.advanced.will_perform_network_activity', 'update')
    ...
    async def download_update(self, *args):
        await self.middleware.call('system.advanced.will_perform_network_activity', 'update')
...
async def setup(middleware):
    await middleware.call('system.advanced.register_network_activity', 'update', 'Update')
