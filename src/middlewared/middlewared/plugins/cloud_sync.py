...
async def rclone(middleware, job, cloud_sync, dry_run=False):
    await middleware.call("system.advanced.will_perform_network_activity", "cloud_sync")
...
class CredentialsService(CRUDService):
    ...
    async def verify(self, data):
        ...
        """
        await self.middleware.call("system.advanced.will_perform_network_activity", "cloud_sync")
...
async def setup(middleware):
    ...
    await middleware.call('system.advanced.register_network_activity', 'cloud_sync', 'Cloud sync')
